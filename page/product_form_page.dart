...
class ProductFormPage extends StatefulWidget {
  ...
  const ProductFormPage({super.key, required this.product, this.onSave});
...
class _ProductFormPageState extends State<ProductFormPage> {
  ...
  void initState() {
    ...
    if (widget.product != null) {
      ...
      _productQuantityController
          .updateValue(widget.product!.quantidade.toDouble());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          widget.product != null ? 'Editando Produto' : 'Cadastrar Produto',
